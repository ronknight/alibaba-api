...
if len(sys.argv) < 2:
    print("Usage: python script.py <category_id>")
    sys.exit(1)

category_id = sys.argv[1]  # Get category_id from command-line argument
...
params = {
    ...
    "v": "2.0",
    "category_id": category_id,  # Category ID from command-line argument
    "language": "ENGLISH",  # Language set to English
    "product_type": "wholesale",  # Product type, e.g., 'wholesale'
}
